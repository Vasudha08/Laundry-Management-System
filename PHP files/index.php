...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $roll_number = $_POST['student_id']; // Make sure this matches the input field name
    $password = $_POST['password'];

    // Check if student ID exists
    $sql = "SELECT * FROM students WHERE roll_number = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("s", $roll_number); // Use $roll_number here
    $stmt->execute();
...
<div class="container">
    ...
    <div class="right-section">
        ...
        <p class="staff-login">If you're staff, <a href="staff_index.php">click here to login</a>.</p>
    </div>
</div>
